...
export function WebsiteFeatures() {
  ...
  const features = [
    {
      ...
      icon: FileText,
      color: "green",
      image: "https://media.istockphoto.com/id/2050489925/photo/blue-question-marks-background-faq-concept.jpg?s=2048x2048&w=is&k=20&c=CQeXtfLIPvTg3HWRL7efqSX_NscA06AVo7W7_YGQr5c=",
      details: [
    ...
    },
    {
      ...
      icon: Brain,
      color: "amber",
      image: "https://media.istockphoto.com/id/677930082/photo/diverse-female-college-students-use-notecards-in-campus-library.jpg?s=2048x2048&w=is&k=20&c=6wQfwsQLNc5bWXCuWzfIDfx6DnpC8ha29A6jvxSf-5U=",
      details: [
    ...
    },
    {
      ...
      icon: Book,
      color: "blue",
      image: "https://media.istockphoto.com/id/1919863292/photo/e-learning-education-internet-lessons-and-online-learning-with-webinars-video-tutorials.jpg?s=2048x2048&w=is&k=20&c=4wwOB8IgcyYrKYOD_oUuVPGm47c7p5comDJcY_y9S8k=",
      details: [
    ...
    },
    {
      ...
      icon: Clock,
      color: "red",
      image: "https://images.unsplash.com/photo-1508599804355-8ce5238b44b1?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      details: [
    ...
    },
    {
      ...
      icon: Zap,
      color: "purple",
      image: "https://plus.unsplash.com/premium_photo-1725907643556-e987fab4b09d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      details: [
  ...
  return (
    <section id="features" ref={sectionRef} className="py-24">
      <div className="container mx-auto w-full max-w-[1400px] px-4 sm:px-6">
        <div
        ...
        >
          <div className="flex flex-col items-center text-center p-6 rounded-xl border bg-muted/30">
            ...
            <p className="text-muted-foreground">
              Our advanced AI analyzes your study materials and learning patterns to create personalized study
              experiences.
            </p>
          </div>
